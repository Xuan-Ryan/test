...
# CONFIG_ARM_ERRATA_782773 is not set
CONFIG_ARM_GIC=y
CONFIG_FIQ_GLUE=y
...
CONFIG_CMDLINE="console=tty0 console=ttyMT3,921600n1 root=/dev/ram vmalloc=496M selinux=0 slub_max_order=0 slub_debug=O "
...
# CONFIG_CPU_FREQ_DEFAULT_GOV_HYBRID is not set
...
# CONFIG_CPU_FREQ_GOV_HYBRID is not set
...
CONFIG_TOI=y
# CONFIG_TOI_ZRAM_SUPPORT is not set
CONFIG_PM_SLEEP=y
...
# CONFIG_UNIX_SOCKET_TRACK_TOOL is not set
...
CONFIG_FTRACE=y
CONFIG_FTRACE_MODULE_SUPPORT=y
...
CONFIG_FUNCTION_DURATION_TRACER=y
CONFIG_MT65XX_TRACER=y
...
CONFIG_MT_LOAD_BALANCE_PROFILER=y
...
CONFIG_L1C_OPT=y
# CONFIG_VFP_OPT is not set
# CONFIG_MTK_FORCE_CPU_27T is not set
# CONFIG_GATOR_DRIVER is not set

#
# MT8590 Board Support Package
#
CONFIG_MT8590_FPGA=y
# CONFIG_MT8590_EVB_BOARD is not set
CONFIG_MT8590_FPGA_CA7=y
CONFIG_MAX_DRAM_SIZE_SUPPORT=0x20000000
...
# CONFIG_MTK_EEMCS_DEVICES is not set
CONFIG_MTK_FB=y
