...
# Bluetooth-apps
#
# CONFIG_BLUEANGEL is not set
# CONFIG_BLUEANGEL_MTKBT is not set
# CONFIG_BLUEANGEL_BTCLI is not set
# CONFIG_BLUEANGEL_RELAYER is not set
...
CONFIG_USER_QOS=y
# CONFIG_RALINKAPP_HWQOS is not set
