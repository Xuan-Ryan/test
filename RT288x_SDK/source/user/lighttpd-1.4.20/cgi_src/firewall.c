...
{
	system("cat /proc/sys/net/netfilter/nf_conntrack_udp_timeout > /var/.udpbackup");
	system("echo 0 > /proc/sys/net/netfilter/nf_conntrack_udp_timeout");
	system("cat /var/.udpbackup > /proc/sys/net/netfilter/nf_conntrack_udp_timeout; rm -f /var/.udpbackup");

	system("cat /proc/sys/net/netfilter/nf_conntrack_tcp_timeout_established > /var/.tcpbackup");
	system("echo 0 > /proc/sys/net/netfilter/nf_conntrack_tcp_timeout_established");
	system("cat /var/.tcpbackup > /proc/sys/net/netfilter/nf_conntrack_tcp_timeout_established; rm -f /var/.tcpbackup");
}
